...
const bcgovBlockThemeAccessibility = () => {
  ...
  window.requestAnimationFrame(() => {
    ...
    const postContentExists = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('#post-content');
    ...
    if (!postContentExists) {
      ...
      const bcgovBodyContentMain = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('main');
      const firstH1 = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('h1');
...
/***/ "./src/scripts/public/alpha-v3/search.js":
/*!***********************************************!*\
  !*** ./src/scripts/public/alpha-v3/search.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const bcgovBlockThemeSearch = () => {
   ...
   */
  window.requestAnimationFrame(() => {
    const toggleSearchBtn = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('.toggle-search-btn a');
    const searchFieldContainer = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('#search-field-container');
    if (toggleSearchBtn) {
      if (searchFieldContainer) {
        const siblingElement = searchFieldContainer.previousElementSibling;
        const searchInput = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('input', searchFieldContainer);
        const searchButton = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('button', searchFieldContainer);
        ...
        if (searchFieldContainer) {
          searchInput.addEventListener('blur', function (event) {
            event.preventDefault();
            window.requestAnimationFrame(() => {
              if (searchButton === event.target.ownerDocument.activeElement) return;
              if (toggleSearchBtn === event.target.ownerDocument.activeElement) return;
          ...
          searchButton.addEventListener('blur', function (event) {
            event.preventDefault();
            window.requestAnimationFrame(() => {
              if (searchInput === event.target.ownerDocument.activeElement) return;
              if (toggleSearchBtn === event.target.ownerDocument.activeElement) return;
              toggleSearchBtn.focus();
              toggleSearchBtn.click();
            });
...
if ('complete' === document.readyState) {
  ...
  (0,_utils__WEBPACK_IMPORTED_MODULE_0__.addSafeEventListener)(document, 'DOMContentLoaded', bcgovBlockThemeSearch());
}
...
const bcgovBlockThemeDomLoader = () => {
  ...
  window.requestAnimationFrame(() => {
    ...
    const postSingleHeaderGroup = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('.bcgov-header-container');
    const postSingleContent = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('.bcgov-body-content');
    const adminBar = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('#wpadminbar');
    const searchFieldContainer = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.qs)('#search-field-container');
    if (null !== customCSS) {
    ...
    window.requestAnimationFrame(() => {
      ...
      if (headerGroup && header) {
        headerGroupHeight = window.getComputedStyle(headerGroup).getPropertyValue('height');
        headerHeight = window.getComputedStyle(header).getPropertyValue('height');
      }
      // Check if the admin bar is present. If so, get its computed height.
      if (adminBar) {
        adminBarHeight = window.getComputedStyle(adminBar).getPropertyValue('height');
      }
      ...
      if (headerGroupHeight === '0px') {
        ...
        header.style.paddingTop = adminBarHeight ? adminBarHeight : header.style.paddingTop;
        ...
        document.documentElement.style.scrollPadding = headerGroup.clientHeight + 'px';
      }
      ...
      if (postSingleHeaderGroup && postSingleContent) {
        postSingleContent.style.minHeight = 'calc(100dvh - (' + headerGroupHeight + ' + ' + footerHeight + '))';
      }
    });
...
/* harmony import */ var _alpha_v3_search__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./alpha-v3/search */ "./src/scripts/public/alpha-v3/search.js");
/* harmony import */ var _admin_blocks_collapse_app__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../admin/blocks/collapse/app */ "./src/scripts/admin/blocks/collapse/app.js");
/**
